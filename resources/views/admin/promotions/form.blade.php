...
<div class="topbar">
    ...
    <a href="{{ route('admin.promotions.index') }}">← Back</a>
</div>

<div class="admin-card form-box">
    <div class="admin-card-body">
        <form action="{{ isset($promotion) ? route('admin.promotions.update', $promotion) : route('admin.promotions.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if(isset($promotion))
                @method('PUT')
            @endif
