...
<head>
    ...
    <title>HoneyBee Shop - <?php echo $__env->yieldContent('title'); ?></title>
    <style>
...
<body>
    <nav>
        <a href="/">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="HoneyBee Shop" style="height: 50px; width: auto;">
        </a>
        <ul>
            <li><a href="/">Home</a></li>
    ...
    <footer style="background-color: #1a1a1a; color: #aaa; padding: 40px; margin-top: 60px;">
      <div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 30px; max-width: 1100px; margin: 0 auto;">
        ...
        <div>
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="HoneyBee" style="height: 60px; margin-bottom: 15px;">
...
</html><?php /**PATH C:\xampp\htdocs\HoneyBeeshop\resources\views/layouts/app.blade.php ENDPATH**/ ?>